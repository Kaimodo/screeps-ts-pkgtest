...
import { ScreepsSocial } from "./utils/screeps-social/index";
// mport { ScreepsSocial } from 'screeps-social';
...
const social = new ScreepsSocial(); // or with a custom path
// const social = new ScreepsSocial('path/to/customLanguage.js');
...
export const loop = ErrorMapper.wrapLoop(() => {
  ...
  */
  ...
  for (let creep of creeps) {
    ...
    // Test the ScreepsSocial talk functionality
    if (creep.memory.screepssocial) {
      // Use the talk method, for example, to greet
      social.talk(creep, "greetings", "hello");
    }
  }
